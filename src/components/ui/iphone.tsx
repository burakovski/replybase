  ...
  return (
    ...
    >
      ...
      {!hasVideo && !src && children ? (
        <div
          className="absolute z-0 overflow-hidden bg-[var(--chat-surface)]"
          style={screenStyle}
        >
          {children}
        </div>
      ...
      <svg
        ...
        aria-hidden
      >
        <g mask={hasMedia ? `url(#${maskId}-punch)` : undefined}>
          <path
        ...
        <path
          ...
          mask={hasMedia ? `url(#${maskId}-punch)` : undefined}
        />
        ...
        <defs>
          <mask id={`${maskId}-punch`} maskUnits="userSpaceOnUse">
            <rect
              x="0"
              y="0"
              width={PHONE_WIDTH}
